...
class _HomePageState extends State<HomePage> {
  ...
  List boxCardItems = [
    {
      "title": AppLocalization.strings.appointment_title,
    ...
    {
      "title": AppLocalization.strings.vitals,
    ...
    {
      "title": AppLocalization.strings.prescription,
    ...
    {
      "title": AppLocalization.strings.profile,
    ...
    {
      "title": AppLocalization.strings.familyMember,
    ...
    {
      "title": AppLocalization.strings.wallet,
    ...
    {
      "title": AppLocalization.strings.notification,
    ...
    {
      "title": AppLocalization.strings.contactUs,
    ...
    {
      "title": AppLocalization.strings.files,
    ...
    return PopScope(
      ...
      child: Scaffold(
          ...
          drawer: IDrawerWidget()
              .buildDrawerWidget(userController, _notificationDotController),
                      ...
                      GestureDetector(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              AppLocalization.strings.appointments,
                              style: TextStyle(
                                  fontSize: 12,
      ...
      child: ListTile(
        ...
        title: Padding(
            ...
            child: Row(
                ...
                children: [
                  Text(
                    AppLocalization.strings.department,
                    style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14),
                  ),
                  dataList.length < 4
                      ? Container()
                      : Text(
                          AppLocalization.strings.swipe_more,
                          style: TextStyle(
                              color: Colors.grey,
      ...
      child: ListTile(
        ...
        title: Padding(
            ...
            child: Row(
                ...
                children: [
                  Text(
                    AppLocalization.strings.doctors,
                    style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14),
                  ),
                  dataList.length < 3
                      ? Container()
                ...
                Flexible(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 2),
                        Text(
                          "${doctorsModel.averageRating} (${doctorsModel.numberOfReview} ${AppLocalization.strings.review})",
                          style: const TextStyle(
                              color: ColorResources.secondaryFontColor,
                              fontWeight: FontWeight.w500,
                              fontSize: 12),
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        AppLocalization.strings.welcome,
                        style: TextStyle(
                      ...
                      const SizedBox(height: 5),
                      Text(
                        AppLocalization.strings.how_its_going_today,
                        style: TextStyle(
                            color: ColorResources.secondaryFontColor,
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.toNamed(RouteHelper.getDoctorsListPageRoute(
                              selectedDeptTitle: "", selectedDeptId: ""));
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              AppLocalization.strings.book_appointment,
                              style:
                  ...
                  doctorImage == ""
                      ...
                      : Flexible(
                          child: SizedBox(
                              ...
                              child: ImageBoxFillWidget(
                                  imageUrl:
                                      "${ApiContents.imageUrl}/$doctorImage")),
                        )
                ],
              ),
            )
      ...
      builder: (BuildContext context) {
        ...
        return PopScope(
          ...
          child: AlertDialog(
            ...
            title: Text(
              AppLocalization.strings.update,
              textAlign: TextAlign.center,
            ...
            content: Column(
              ...
              children: [
                Text(
                    isCancel
                        ? AppLocalization.strings.message_cancel
                        : AppLocalization.strings.message_force,
                    textAlign: TextAlign.center,
                    style: const TextStyle(
      ...
      builder: (BuildContext context) {
        ...
        return PopScope(
          ...
          child: AlertDialog(
            ...
            title: Text(
              AppLocalization.strings.issue_title,
              textAlign: TextAlign.center,
              style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18),
            ),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(AppLocalization.strings.issue_message,
                    textAlign: TextAlign.center,
                    style:
        ...
        subtitle: Padding(
          ...
          child: Row(
            ...
            children: [
              phone == null || phone == ""
                  ? Container()
                  : _buildTapBox(ImageConstants.telephoneImageBox,
                      AppLocalization.strings.call, () async {
                      if (phone != null && phone != "") {
              ...
              whatsapp == null || whatsapp == ""
                  ...
                  : Padding(
                      ...
                      child: _buildTapBox(ImageConstants.whatsappImageBox,
                          AppLocalization.strings.whatsapp, () async {
                        if (whatsapp != null && whatsapp != "") {
                          final url =
                              "https://wa.me/$whatsapp?text=Hello"; //remember country code
              ...
              email == null || email == ""
                  ...
                  : Padding(
                      padding: const EdgeInsets.only(left: 20),
                      child: _buildTapBox(ImageConstants.emailImageBox,
                          AppLocalization.strings.email, () async {
                        if (email != null && email != "") {
              ...
              clinicLng == null ||
                  ...
                  : Padding(
                      padding: const EdgeInsets.only(left: 20),
                      child: _buildTapBox(
                          ImageConstants.mapPlaceImageBox, "Map", () async {
                        if (clinicLng != null &&
                            clinicLng != "" &&
                            clinicLat != null &&
                            clinicLat != "") {
                          final url =
                              "http://maps.google.com/maps?daddr=$clinicLat,$clinicLng";
                          try {
                            await launchUrl(Uri.parse(url),
                                mode: LaunchMode.externalApplication);
                          } catch (e) {
              ...
              ambulancePhone == null || ambulancePhone == ""
                  ? Container()
                  : Flexible(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20),
                        child: _buildTapBox(ImageConstants.ambulanceImageBox,
                            AppLocalization.strings.ambulance, () async {
